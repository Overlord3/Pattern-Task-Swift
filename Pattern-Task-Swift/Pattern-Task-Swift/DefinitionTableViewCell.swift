...
{
	var definitionLabel = UILabel() /**< Лейбл для определения слова */
	var authorLabel = UILabel() /**< Лейбл для имени автора */
	var exampleLabel = UILabel() /**< Лейбл для примеров использования */
	var dateLabel = UILabel() /**< Лейбл для даты */
